...
ggplot(combinedWine, aes(x = Residual_Sugar, y = Quality)) + 
...
#white 
ggplot(white_train, aes(x = Residual_Sugar, y = Quality)) + 
  geom_boxplot(aes(fill = Quality)) +
...
#red
ggplot(red_train, aes(x = Residual_Sugar, y = Quality)) + 
  geom_boxplot(aes(fill = Quality)) +
...
ggplot(combinedWine, aes(x = Free_Sulfur_Dioxide, y = Quality)) + 
  geom_boxplot(aes(fill = Quality)) +
...
#FSD - white
ggplot(white_train, aes(x = Free_Sulfur_Dioxide, y = Quality)) + 
  geom_boxplot(aes(fill = Quality)) +
...
#FSD - red
ggplot(red_train, aes(x = Free_Sulfur_Dioxide, y = Quality)) + 
  geom_boxplot(aes(fill = Quality)) +
...
ggplot(combinedWine, aes(x = Total_Sulfur_Dioxide, y = Quality)) + 
  geom_boxplot(aes(fill = Quality)) +
...
#TSD - white
ggplot(white_train, aes(x = Total_Sulfur_Dioxide, y = Quality)) + 
  geom_boxplot(aes(fill = Quality)) +
...
#TSD - red
ggplot(red_train, aes(x = Total_Sulfur_Dioxide, y = Quality)) + 
  geom_boxplot(aes(fill = Quality)) +
...
#sulfates - white
ggplot(white_train, aes(x = Sulfates, y = Quality)) + 
  geom_boxplot(aes(fill = Quality)) +
...
#sulfates - red
ggplot(red_train, aes(x = Sulfates, y = Quality)) + 
  geom_boxplot(aes(fill = Quality)) +
...
```{r recipe}
white_recipe <- recipe(Quality ~ Fixed_Acidity + Volatile_Acidity + Citric_Acid + Residual_Sugar + Chlorides + Free_Sulfur_Dioxide + Total_Sulfur_Dioxide + Density + pH + Sulfates + Alcohol, data = white_train) %>% 
  step_dummy(all_nominal_predictors()) %>% 
  step_interact(~ ends_with("Acidity"):Citric_Acid + Fixed_Acidity:Density + Fixed_Acidity:pH + Free_Sulfur_Dioxide:Total_Sulfur_Dioxide)

white_recipe

red_recipe <- recipe(Quality ~ Fixed_Acidity + Volatile_Acidity + Citric_Acid + Residual_Sugar + Chlorides + Free_Sulfur_Dioxide + Total_Sulfur_Dioxide + Density + pH + Sulfates + Alcohol, data = red_train) %>% 
  step_dummy(all_nominal_predictors()) %>% 
  step_interact(~ ends_with("Acidity"):Citric_Acid + Fixed_Acidity:Density + Fixed_Acidity:pH + Free_Sulfur_Dioxide:Total_Sulfur_Dioxide)
