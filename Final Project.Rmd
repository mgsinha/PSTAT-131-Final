...
# Adding variable type so that we can do analysis on the combinedWine data set easily 
white$Type <- "White"
red$Type <- "Red"
```
...
ggplot(combinedWine, aes(Quality)) + geom_bar() +labs(title = "Histogram of Quality - Total Wine") + xlab("Quality of Wine") + ylab("Count") #+ scale_fill_manual("pink","pink1","pink2","palevioletred","palevioletred1")

# IDK HOW TO CHANGE THE COLORORORORO 
```
