...
```{r white pca lda, class.source = 'fold-show', eval = FALSE}
...
```{r white pca lda1, class.source = 'fold-show'}
...
ggplot(pca_lda_metrics, aes(x = num_comp, y = mean)) +
  ...
  theme_bw()
```
```{r white pca lda2, class.source = 'fold-show', eval = FALSE}
...
```{r white pca lda3, class.source = 'fold-show'}
# plot
...
```{r white pca lda4, class.source = 'fold-show', eval = FALSE}
...
```{r red pca lda recipe, class.source = 'fold-show'}
