...
red_recipe <- recipe(quality ~ volatile.acidity + citric.acid + residual.sugar + chlorides + free.sulfur.dioxide + total.sulfur.dioxide + density + pH + sulphates + alcohol, data = red_train) %>% step_dummy(all_nominal_predictors()) %>% step_interact(~ citric.acid:volatile.acidity + free.sulfur.dioxide:total.sulfur.dioxide)%>% step_normalize(all_predictors())
...
wlog_reg_fit <- fit_resamples(wlog_wkflow, white_fold)
...
#rlog_reg_fit <- fit_resamples(rlog_wkflow, red_fold)
