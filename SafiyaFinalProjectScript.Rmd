...
rrandfor_final <- rand_forest(mtry = 2, trees = 17, min_n = 30) %>% set_engine("ranger", importance = "impurity") %>% set_mode("classification")
wrandfor_fit_final <- fit(wrandfor_final, data = white_train)
...
best_roc_table <- rbind(best_rocauc[1,c(2,4)], best_rocauc1[1,c(4,6)], best_rocauc2[1,c(2,4)] )
best_roc_table
```
